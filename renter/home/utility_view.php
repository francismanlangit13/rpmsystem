...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">View My Bills</h1>
        <ol class="breadcrumb mb-4 mt-3">
            <li class="breadcrumb-item active"><a href="../home" class="text-decoration-none">Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="./utility" class="text-decoration-none">My Bills</a></li>
            <li class="breadcrumb-item">View My Bills</li>
        </ol>
        <?php
            if(isset($_GET['id'])) {
                $id = $_GET['id'];
