                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control btn-disabled" id="role" disabled>
                                            <option value="Renter" selected>Rentee</option>
                                        </select>
                                ...
                                <!-- Select2 Example -->
                                <div class="col-md-4 mb-3" id="Container3">
                                    <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-3" id="Container6">
                                        ...
                                        <div class="col-md-6 mt-3" id="Container7">
                                            <label for="cash_deposit" class="required">Cash Deposit</label>
                                            <input type="number" class="form-control" name="cash_deposit" id="cash_deposit">
                                ...
                                <div class="col-md-2 mb-3" id="Container4">
                                ...
                                <div class="col-md-2 mb-3" id="Container5">
