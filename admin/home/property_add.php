                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3 d-none" id="Container2">
                                    ...
                                    <input type="number" class="form-control" placeholder="Enter Advance Payment" name="property_cash_advance" id="property_cash_advance">
                                ...
                                <div class="col-md-3 mb-3 d-none" id="Container3">
                                    ...
                                    <input type="number" class="form-control" placeholder="Enter Cash Deposit" name="property_cash_deposit" id="property_cash_deposit">
