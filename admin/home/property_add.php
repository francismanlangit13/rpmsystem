                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Barangay" name="property_barangay" id="property_barangay" required>
                                    <div id="property_barangay-error"></div>
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="property_city" class="required">City</label>
                                    <input type="text" class="form-control" placeholder="Enter City" name="property_city" id="property_city" required>
                                    <div id="property_city-error"></div>
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="property_zipcode" class="required">Zipcode</label>
                                    <input type="number" class="form-control" placeholder="Enter Zipcode" name="property_zipcode" id="property_zipcode" required>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="add_property" id="addButton" class="btn btn-success">Yes</button>
                        </div>
                    </div>
                </div>
            </div>
