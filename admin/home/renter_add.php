                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Renter form
                                <div class="float-end">
                                    <button type="submit" name="add_renter" class="btn btn-primary"><i class="fas fa-plus"></i> Add</button>
                                </div>
                            </h4>
                        </div>
                        <div class="card-body">
