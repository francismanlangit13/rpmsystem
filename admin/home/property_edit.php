                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Building Permit" name="property_permit" id="property_permit" value="<?=$row['property_permit']?>" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Purok" name="property_purok" id="property_purok" value="<?=$row['property_purok']?>" required>
