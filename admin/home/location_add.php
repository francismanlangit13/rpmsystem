                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Location form
                                <div class="float-end">
                                    <button type="submit" name="add_location" class="btn btn-primary"><i class="fas fa-plus"></i> Add</button>
                                </div>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter location" name="location_name" id="location_name" required>
