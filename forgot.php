...
<html lang="en">
    <head>
        ...
        <title>Forgot | Rental Properties Management System</title>
        <!-- Favicons -->
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        ...
                                        <h4 class="text-center font-weight-light my-4">Forgot Password</h4>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form action="forgotcode.php" method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="index">Back to login</a>
                                                <button type="submit" name="forgot_btn" class="btn btn-primary">Reset password</button>
                                            </div>
                                        </form>
                                    </div>
